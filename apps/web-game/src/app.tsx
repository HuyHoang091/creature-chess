			...
			{modal === "signin-required" && (
				...
				>
					...
					>
						...
						<p>
							Friends, party, private lobbies, and persistent history require an authenticated account.
						</p>
						<p>
							Auth0 is currently disabled in your environment, so only guest quick play is active right now.
						</p>
						<button
