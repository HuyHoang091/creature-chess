...
export type UpdateConnectionStatusAction = {
...
export const setWinnerIdCommand = createAction<
	{ winnerId: string },
	"setWinnerIdCommand"
>("setWinnerIdCommand");
...
export const clearSelectedPiece = (): ClearSelectedPieceAction => ({
	type: CLEAR_SELECTED_PIECE,
});
...
export const REVEAL_ENEMY_PIECES = "REVEAL_ENEMY_PIECES";
export type REVEAL_ENEMY_PIECES = typeof REVEAL_ENEMY_PIECES;
export const HIDE_ENEMY_PIECES = "HIDE_ENEMY_PIECES";
export type HIDE_ENEMY_PIECES = typeof HIDE_ENEMY_PIECES;

export type RevealEnemyPiecesAction = { type: REVEAL_ENEMY_PIECES };
export type HideEnemyPiecesAction = { type: HIDE_ENEMY_PIECES };

export const revealEnemyPieces = (): RevealEnemyPiecesAction => ({
    type: REVEAL_ENEMY_PIECES,
});
export const hideEnemyPieces = (): HideEnemyPiecesAction => ({
    type: HIDE_ENEMY_PIECES,
});
