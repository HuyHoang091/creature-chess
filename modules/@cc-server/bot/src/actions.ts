...
export const getActions = (
	...
	// item actions: craft first (most valuable), then equip
	actions.push(createCraftItemAction(state, personality, settings));
	actions.push(createEquipItemAction(state, personality, settings));
