import { CreatureStats, AttackType, attackTypes, SkillDefinition } from "@creature-chess/models";
...
const getStats = (
	...
	return {
		hp: getStat(baseStats.hp, build.hp, availablePoints) * 5,
...
export const getStages = (traits: TraitId[], cost: number, skill?: SkillDefinition): CreatureStats[] => [
	{...getStats(traits, cost, 0), skill, maxMana: skill?.manaCost},
	{...getStats(traits, cost, 1), skill, maxMana: skill?.manaCost},
	{...getStats(traits, cost, 2), skill, maxMana: skill?.manaCost},
];
